...
//since that's all we need here
    ...
    var getAllData = function () {
        $http.get(baseRemoteURL+'calculadora/list/.json').success(function (data) {//console.log(data);
    ...
    function calcularAjax(postData) {
        var muted = false;
        if(!muted) console.log('\n');
        $http.post(baseRemoteURL+'calculadora/calcular', {"postData": postData}).success(function(data) {
...
calculadoraControllers.filter('printString', function() {
